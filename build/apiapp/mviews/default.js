...
KISSY.add('apiapp/mviews/default', function(S, View, Magix, VOM) {
    var NonClass = {
     ...
     return View.extend({tmpl:"<div id=\"header\"> <vframe mx-view=\"apiapp/mviews/partials/header\"></vframe> </div> <div style=\"margin-top: 50px;\"> <vframe id=\"magix_vf_main\">哥正在用绳命加载，请稍候哦...</vframe> </div> <vframe mx-view=\"apiapp/mviews/partials/footer\" id=\"magix_vf_footer\"></vframe>",
        init: function() {
